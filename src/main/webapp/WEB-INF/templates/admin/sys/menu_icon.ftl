    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>所有图标 <small class="m-l-sm">单击选择你想要选择的图标</small></h5>
        ...
        <div class="ibox-content icons-box">
          <section id="new">
            ...
            <div class="row fontawesome-icon-list">
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#y-combinator"><i class="fa fa-yc"></i>yc </a></div>
            </div>
          </section>
          ...
          <section id="gender">
            ...
            <div class="row fontawesome-icon-list">
              <div class="fa-hover col-md-3 col-sm-4"><a href="#genderless"><i class="fa fa-genderless"></i>genderless</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#transgender"><i class="fa fa-intersex"></i>intersex </a></div>
          ...
          <section id="spinner">
            ...
            <div class="alert alert-success">
              <ul class="fa-ul">
                <li> <i class="fa fa-info-circle fa-lg fa-li"></i>给这些图标加上 <code>fa-spin</code> class，就可以表现出加载动画了 </li>
              </ul>
            </div>
            <div class="row fontawesome-icon-list">
              <div class="fa-hover col-md-3 col-sm-4"><a href="#circle-o-notch"><i class="fa fa-circle-o-notch"></i>circle-o-notch</a></div>
          ...
          <section id="currency">
            ...
            <div class="row fontawesome-icon-list">
              <div class="fa-hover col-md-3 col-sm-4"><a href="#btc"><i class="fa fa-bitcoin"></i>bitcoin </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#btc"><i class="fa fa-btc"></i>btc</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#jpy"><i class="fa fa-cny"></i>cny </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#usd"><i class="fa fa-dollar"></i>dollar </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#eur"><i class="fa fa-eur"></i>eur</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#eur"><i class="fa fa-euro"></i>euro </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#money"><i class="fa fa-money"></i>money</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#jpy"><i class="fa fa-rmb"></i>rmb </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#rub"><i class="fa fa-rouble"></i>rouble </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#rub"><i class="fa fa-rub"></i>rub</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#rub"><i class="fa fa-ruble"></i>ruble </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#inr"><i class="fa fa-rupee"></i>rupee </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#ils"><i class="fa fa-shekel"></i>shekel </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#ils"><i class="fa fa-sheqel"></i>sheqel </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#try"><i class="fa fa-try"></i>try</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#try"><i class="fa fa-turkish-lira"></i>turkish-lira </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#usd"><i class="fa fa-usd"></i>usd</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#krw"><i class="fa fa-won"></i>won </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#jpy"><i class="fa fa-yen"></i>yen </a></div>
            </div>
          </section>
          <section id="text-editor">
            ...
            <div class="row fontawesome-icon-list">
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#link"><i class="fa fa-chain"></i>chain </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#files-o"><i class="fa fa-copy"></i>copy </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#scissors"><i class="fa fa-cut"></i>cut </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#outdent"><i class="fa fa-dedent"></i>dedent </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#eraser"><i class="fa fa-eraser"></i>eraser</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#file"><i class="fa fa-file"></i>file</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#file-o"><i class="fa fa-file-o"></i>file-o</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#file-text"><i class="fa fa-file-text"></i>file-text</a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#clipboard"><i class="fa fa-paste"></i>paste </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#repeat"><i class="fa fa-repeat"></i>repeat</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#undo"><i class="fa fa-rotate-left"></i>rotate-left </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#repeat"><i class="fa fa-rotate-right"></i>rotate-right </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#floppy-o"><i class="fa fa-save"></i>save </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#chain-broken"><i class="fa fa-unlink"></i>unlink </a></div>
            </div>
          </section>
          ...
          <section id="brand">
            ...
            <div class="row fontawesome-icon-list margin-bottom-lg">
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#facebook"><i class="fa fa-facebook-f"></i>facebook-f </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#empire"><i class="fa fa-ge"></i>ge </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#get-pocket"><i class="fa fa-get-pocket"></i>get-pocket</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#gg"><i class="fa fa-gg"></i>gg</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#gg-circle"><i class="fa fa-gg-circle"></i>gg-circle</a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#gratipay"><i class="fa fa-gittip"></i>gittip </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#rebel"><i class="fa fa-ra"></i>ra </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#weixin"><i class="fa fa-wechat"></i>wechat </a></div>
              ...
              <div class="fa-hover col-md-3 col-sm-4"><a href="#y-combinator"><i class="fa fa-y-combinator"></i>y-combinator</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#hacker-news"><i class="fa fa-y-combinator-square"></i>y-combinator-square </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#yahoo"><i class="fa fa-yahoo"></i>yahoo</a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#y-combinator"><i class="fa fa-yc"></i>yc </a></div>
              <div class="fa-hover col-md-3 col-sm-4"><a href="#hacker-news"><i class="fa fa-yc-square"></i>yc-square </a></div>
...
<myfooter> 
  <script type="text/javascript">
		$(function(){
			...
			$(".ibox-content a").click(function(){
				if (icon != null && icon != "") {
					parent.$("input[name='icon']").val(icon);
