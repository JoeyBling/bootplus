                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    ...
                                    <table id="table"
                                           ...
                                           data-url="${ctx}/admin/sys/menu/list" [#-- 服务器数据URL --]
                ...
                <form id="form">
                    ...
                    <div id="iconDiv">
	              	 ...
	              	 <button type="button" class="btn btn-primary"
                             onclick="layer_show_url('菜单图标','${ctx}/admin/sys/menu_icon.html','800','600')" title="图标">
                         选择
                     </button>
...
<link rel="stylesheet" href="${ctxstatic}/common/ztree/css/metroStyle/metroStyle.css">
<script src="${ctxstatic}/common/ztree/js/jquery.ztree.all.min.js"></script>
...
<!-- 自定义js -->
<script src="${ctxstatic}/js/admin/sys/menu.js"></script>
[#-- 页面加载进度条 --]
