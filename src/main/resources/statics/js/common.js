// 命名空间定义
var bootplus = window.NameSpace || {};

bootplus.base = "/";
bootplus.url = "http://bootplus.diandianys.com/";
...
// JS进度条
// 开始
bootplus.progressBarStartUp = function (type) {
...
// 开始到指定位置 0-1
bootplus.progressBarSet = function (speed) {
    if (typeof NProgress != "undefined") {
        NProgress.set(speed);
    }
};
// 结束
bootplus.progressBarShutDown = function () {
    if (typeof NProgress != "undefined") {
        NProgress.done();
    }
};
